 ...
 */
function buildRatingContext (options: any = {}) {
 ...
 */
function buildTargetHistory (reviewRows, challengeMetadataById, options: any = {}) {
 ...
 */
async function rerateDevTrack (membersClient, challengeClient, reviewDbClient, userId, fromChallengeId, options: any = {}) {
  if (!reviewDbClient) {
