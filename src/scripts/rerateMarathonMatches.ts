 ...
 *   pnpm rerate-marathon-matches --limit 100
 * - Re-rate specific users by userId:
 *   pnpm rerate-marathon-matches --user-id 12345 --user-ids 67890,24680
 *
 * Notes:
...
function printUsage () {
  console.log(`
Usage:
  pnpm rerate-marathon-matches [options]
 ...
 */
async function discoverMarathonMatchMembers (reviewDbClient, marathonHistory, options: any = {}) {
