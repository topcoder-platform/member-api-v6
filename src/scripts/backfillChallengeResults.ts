 ...
 *   pnpm backfill-challenge-results
 * - Preview one challenge:
 *   pnpm backfill-challenge-results --challenge-id 21d5ea84-dfa4-43ad-afd8-483942aff152
 * - Apply all missing rows:
 *   pnpm backfill-challenge-results --apply
 * - Apply only recently completed challenges:
 *   pnpm backfill-challenge-results --apply --from-date 2026-03-01
 *
 * Notes:
...
function printUsage () {
  console.log(`Usage:
  pnpm backfill-challenge-results [options]
