 ...
 *   pnpm rerate-rating-path --rating-name "AI Engineering" --user-id 12345 --user-ids 67890,24680
 *
 * Notes:
...
function printUsage () {
  console.log(`
Usage:
  pnpm rerate-rating-path --rating-name <name> [options]
 ...
 */
async function discoverRatingPathMembers (reviewDbClient, pathHistory, options: any = {}) {
