 ...
 * Usage examples:
 * - Dry-run discovery:
 *   pnpm rerate-development-challenge --dry-run
 * - Re-rate every discovered member from the start of their Development history:
 *   pnpm rerate-development-challenge --concurrency 5
 * - Re-rate a bounded sample:
 *   pnpm rerate-development-challenge --limit 100
 * - Re-rate specific users by userId:
 *   pnpm rerate-development-challenge --user-id 12345 --user-ids 67890,24680
 *
 * Notes:
...
function printUsage () {
  console.log(`
Usage:
  pnpm rerate-development-challenge [options]
 ...
 */
async function discoverDevelopmentChallengeMembers (reviewDbClient, developmentHistory, options: any = {}) {
