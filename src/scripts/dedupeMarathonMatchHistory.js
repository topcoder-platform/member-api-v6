 ...
 *   node src/scripts/dedupeMarathonMatchHistory.js --dry-run
 * - Preview duplicate rows for one member:
 *   node src/scripts/dedupeMarathonMatchHistory.js --dry-run --user-id 40562752
 * - Delete duplicate migrated rows after reviewing the dry-run output:
 *   node src/scripts/dedupeMarathonMatchHistory.js --apply --user-id 40562752
 */
...
function printUsage () {
  console.log(`
Usage:
  node src/scripts/dedupeMarathonMatchHistory.js [options]
 ...
 */
async function findDuplicateHistoryRows (membersClient, options = {}) {
