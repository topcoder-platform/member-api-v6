...
const servicePath = path.resolve(__dirname, '../../src/services/StatisticsService.ts')
...
const reviewDbPath = path.resolve(__dirname, '../../src/common/reviewDb.ts')
const reviewDbHelperPath = path.resolve(__dirname, '../../src/common/reviewDbHelper.ts')
const statsDimensionHelperPath = path.resolve(__dirname, '../../src/common/statsDimensionHelper.ts')
const developRatingEnginePath = path.resolve(__dirname, '../../src/ratings/developRatingEngine.ts')
const mmRatingEnginePath = path.resolve(__dirname, '../../src/ratings/mmRatingEngine.ts')
const prismaHelperPath = path.resolve(__dirname, '../../src/common/prismaHelper.ts')
